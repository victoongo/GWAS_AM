...
lab val type typ
histogram rho, bin(500) percent by(type, col(1) b1title("Correlation") note("")) xlabel(0(0.25)1) xsize(4) ysize(5) subtitle(, size(medium))


foreach file in mx_ag_all /*mx_agrul_cor02*/ {
