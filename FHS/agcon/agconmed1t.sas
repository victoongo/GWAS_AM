...
libname ag1t '/lustre/scr/v/i/victorw/ag/ag1t';
*libname ag "D:/AM/FHS550k/agcon";
*libname agp "D:/AM/FHS550k/agcon/plst";
%let sect= &sysparm.;

proc sort data=agp.agcon989p&sect. out=temp; by iid; run;
data tempm;
...
data tempm(keep=pair _NAME_ col);
  ...
  else if col1=1 & col2=1 then col=2;
...
proc mixed data=tempr method=ml noitprint noclprint ratio covtest; 
  ...
  ods output CovParms=ag1t.mx_agconmed&sect.; 
run;
ods listing;
