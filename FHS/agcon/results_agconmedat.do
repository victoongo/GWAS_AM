...
usesas using mx_agconmedat_all.sas7bdat, clear
...
lab val type typ
histogram rhomed if colc==6, bin(200) percent by(type col, col(2) b1title("Correlation") note("")) xlabel(-0.5(0.25)1) xsize(4) ysize(3)
