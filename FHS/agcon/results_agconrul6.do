cd "D:\AM\FHS550k\agcon\agconrul6"

usesas using mx_agconrul6_all.sas7bdat, clear
...
save mx_agconrul6_all, replace

use mx_agconrul6_all, clear
...
save mx_agconrul6_mp, replace 

use mx_agconrul6_all, clear
keep if typef=="rpos"
drop typef
*reshape wide rhorul prul, i(pair) j(col)
save mx_agconrul6_rp, replace 

*** 1000 random draw
foreach x of num 1/1000 {
use mx_agconrul6_rp, clear
sample 989, count
gen sampleid=`x'
