cd "D:\AM\FHS550k\agcon\agconrul4"

usesas using mx_agconrul4_all.sas7bdat, clear
...
save mx_agconrul4_all, replace

use mx_agconrul4_all, clear
...
save mx_agconrul4_mp, replace 

use mx_agconrul4_all, clear
keep if typef=="rpos"
drop typef
*reshape wide rhorul prul, i(pair) j(col)
save mx_agconrul4_rp, replace 

*** 1000 random draw
foreach x of num 1/1000 {
use mx_agconrul4_rp, clear
sample 989, count
gen sampleid=`x'
