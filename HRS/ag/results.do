...
*** mixed
usesas using mx_all.sas7bdat, clear
sort pair
save mx_all, replace
...
rename iid1 iid
sort iid
merge m:1 iid using "D:\EDU\pheno\birthyr.dta", nogen keep(1 3)
renvars iid birthyr / iid1 birthyr1
rename iid2 iid
sort iid
merge m:1 iid using "D:\EDU\pheno\birthyr.dta", nogen keep(1 3)
renvars iid birthyr / iid2 birthyr2
egen birthyr=rowmean(birthyr1 birthyr2)
twoway (scatter estimate birthyr, msize(small) msymbol(point) jitter(1)), by(typef)
bysort typef: regress estimate birthyr
*/
